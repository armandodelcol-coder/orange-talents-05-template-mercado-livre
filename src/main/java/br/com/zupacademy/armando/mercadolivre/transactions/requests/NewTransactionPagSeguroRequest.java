...
public class NewTransactionPagSeguroRequest {

    @NotBlank @ExistsBy(entityClass = Purchase.class, fieldName = "code") @PurchaseIsFinalized() @CorrectGateway(gateway = "PagSeguro")
    ...
    public NewTransactionPagSeguroRequest(String purchaseCode, String transactionCode, String status) {
